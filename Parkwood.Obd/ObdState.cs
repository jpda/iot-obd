...
namespace Parkwood.Obd
{
    public class ObdState : Dictionary<string, object>, IDisposable
    {
        ...
        public DateTime Generation = DateTime.MinValue;
        ...
        /// <summary>
        /// Build a dictionary of PIDS supported by this ObdDevice and port
        /// </summary>
        /// <returns></returns>
        public GetSupportedPids()
        {
            ...
            var result = ParsePidCmd(this.port.SendCommand(new ObdPid(0x01, 0x00).PidCommand));
            ...
            //get PIDs 21-40 support
            result = ParseCommandResult(this.port.SendCommand(new ObdPid(0x01, 0x40).PidCommand));
            foreach (var payload in result)
